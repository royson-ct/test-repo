...
// dialog css is taken from the minified main.css
    wzrkPermissionPopup.wzrkCreatePopDiv = function(hidePoweredByCT) {
        ...
        if(!hidePoweredByCT){
            // alert powered by
            createDiv(undefined, msgAlert, 'wzrk-powered', '<a href="https://clevertap.com/messaging-channels/website-push-notifications/?utm_medium=ref&utm_campaign=poweredBy" target="_blank"><img src="PB_CT_new.png" height="15" style="height:15px;"></a>');
        }
